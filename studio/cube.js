(function() {
    ...
    function e(e, t, o) {
        function a() {
            for (var e = Math.cos, a = [new THREE.Vector3(1,1,1), new THREE.Vector3(1,1,-1), new THREE.Vector3(-1,1,-1), new THREE.Vector3(-1,1,1), new THREE.Vector3(1,-1,1), new THREE.Vector3(1,-1,-1), new THREE.Vector3(-1,-1,-1), new THREE.Vector3(-1,-1,1)], s = 0; 8 > s; s++)
                C.push([]),
                L.push([]);
    ...
    const u = ( () => {
        ...
        return new class {
            ...
            add(t) {
                t.id = e++,
                this.ids.push(t.id),
                this.animations[t.id] = t;
                0 !== this.raf || (this.time = performance.now(),
                this.raf = requestAnimationFrame(this.update))
            }
            remove(e) {
                const t = this.ids.indexOf(e.id);
                0 > t || (this.ids.splice(t, 1),
                delete this.animations[e.id],
                e = null)
            }
        }
    }
    ...
    class p extends g {
        constructor(e) {
            ...
            this.camera = new THREE.PerspectiveCamera(2,1,.1,1e4),
            this.stage = {
                width: 2,
                height: 3
            },
    ...
    class h {
        ...
        init() {
            ...
            this.pieces.forEach(e => {
                this.cubes.push(e.userData.cube),
                this.object.add(e)
            }
            ),
        ...
        resize(e=!1) {
            (this.size !== this.sizeGenerated || e) && (this.size = this.game.preferences.ranges.size.value,
            this.reset(),
            this.init(),
            this.game.saved = !1,
        ...
        updateColors(e) {
            'object' != typeof this.pieces && 'object' != typeof this.edges || (this.pieces.forEach(t => t.userData.cube.material.color.setHex(e.P)),
    ...
    const y = {
        Power: {
            ...
            a => 1 - o(s(a - 1, e))),
            InOut: e => (e = r(e || 1),
            a => .5 > a ? s(2 * a, e) / 2 : (1 - o(s(2 * a - 1 - 1, e))) / 2 + .5)
        },
        Sine: {
            In: () => e => 1 + n(i / 2 * e - i / 2),
            Out: () => e => n(i / 2 * e),
    ...
    class b extends g {
        ...
        update(e) {
            ...
            null === this.yoyo ? 1 >= this.progress ? this.onUpdate(this) : (this.progress = 1,
            this.value = 1,
            this.onUpdate(this),
            this.onComplete(this),
            super.stop()) : this.updateYoyo()
        }
        updateYoyo() {
            (1 < this.progress || 0 > this.progress) && (this.value = this.progress = 1 < this.progress ? 1 : 0,
            this.yoyo = !this.yoyo),
            this.onUpdate(this)
        }
        updateFromTo() {
        ...
        getFromTo(e) {
            return e.target && e.to ? void (this.target = e.target || null,
            this.from = e.from || {},
            this.to = e.to || null,
            this.values = [],
            1 > Object.keys(this.from).length && Object.keys(this.to).forEach(e => {
    ...
    class v {
        constructor(e, t) {
            ...
            this.drag = {
                start: e => {
                    'mousedown' == e.type && 1 != e.which || 'touchstart' == e.type && 1 < e.touches.length || (this.getPositionCurrent(e),
                    this.options.calcDelta && (this.position.start = this.position.current.clone(),
                ...
                move: e => {
                    ...
                    this.options.calcDelta && (this.position.delta = this.position.current.clone().sub(this.position.old),
        ...
        enable() {
            return this.element.addEventListener('touchstart', this.drag.start, !1),
            this.element.addEventListener('mousedown', this.drag.start, !1),
            this
        }
        disable() {
            return this.element.removeEventListener('touchstart', this.drag.start, !1),
        ...
        convertPosition(e) {
            return e.x = 2 * (e.x / this.element.offsetWidth) - 1,
    ...
    class x {
        constructor(e) {
            ...
            this.helper = new THREE.Mesh(new THREE.PlaneBufferGeometry(200,200),t.clone()),
            this.helper.rotation.set(0, i / 4, 0),
            this.game.world.scene.add(this.helper),
            this.edges = new THREE.Mesh(new THREE.BoxBufferGeometry(1,1,1),t.clone()),
        ...
        initDraggable() {
            ...
            this.draggable.onDragStart = e => {
                if (null === this.scramble && 1 !== this.state && 2 !== this.state) {
                    ...
                    this.helper.translateZ(.5),
                    this.helper.updateMatrixWorld(),
                    this.detach(this.helper, this.edges)) : (this.dragNormal = new THREE.Vector3(0,0,1),
                    this.flipType = 'cube',
                    this.helper.position.set(0, 0, 0),
                    this.helper.rotation.set(0, i / 4, 0),
                    this.helper.updateMatrixWorld());
                    let a = this.getIntersect(e.current, this.helper, !1);
                    !1 === a || (this.dragCurrent = this.helper.worldToLocal(a.point),
            ...
            this.draggable.onDragMove = e => {
                if (null === this.scramble && this.state !== f && (3 !== this.state || !1 !== this.gettingDrag)) {
                    ...
                    if (!1 !== t) {
                        ...
                        if (this.dragDelta = a.clone().sub(this.dragCurrent).setZ(0),
                        this.dragTotal.add(this.dragDelta),
                        this.dragCurrent = a,
                        this.addMomentumPoint(this.dragDelta),
                        1 === this.state && .05 < this.dragTotal.length()) {
                            if (this.dragDirection = this.getMainAxis(this.dragTotal),
                            'layer' === this.flipType) {
                            ...
                            'layer' === this.flipType ? (this.group.rotateOnAxis(this.flipAxis, e),
                            this.flipAngle += e) : (this.edges.rotateOnWorldAxis(this.flipAxis, e),
        ...
        rotateLayer(e, t, a) {
            ...
            this.rotationTween = new b({
                ...
                onUpdate: t => {
                    let a = t.delta * e;
                    this.group.rotateOnAxis(this.flipAxis, a),
                    n(t.value, a, e)
                }
                ,
                onComplete: () => {
        ...
        keyboardMove(e, t) {
            if (this.state === f && !0 === this.enabled)
                if ('LAYER' === e) {
                    ...
                    'CUBE' === e && (this.flipAxis = new THREE.Vector3,
                    this.flipAxis[t.axis] = 1,
                    this.state = 2,
        ...
        scrambleCube() {
            null == this.scramble && (this.scramble = this.game.scrambler,
            this.scramble.callback = 'function' == typeof callback ? callback : () => {}
            );
            ...
            this.rotateLayer(t.angle, !0, () => {
                e.shift(),
                0 < e.length ? this.scrambleCube() : (this.scramble = null,
                this.game.storage.saveGame())
            }
            )
        }
        ...
        getMomentum() {
            const e = this.momentum.length
              , t = new THREE.Vector2;
            return this.addMomentumPoint(!1),
    ...
    class z {
        ...
        scramble(e) {
            let t = 0;
            if (this.moves = 'undefined' == typeof e ? [] : e.split(' '),
            1 > this.moves.length) {
                ...
                for (; t < r; ) {
                    ...
                    0 < t && e.charAt(0) == this.moves[t - 1].charAt(0) || 1 < t && e.charAt(0) == this.moves[t - 2].charAt(0) || (this.moves.push(e),
                    t++)
                }
            }
        ...
        convert() {
            ...
            this.moves.forEach(e => {
                const t = this.convertMove(e)
                  , a = e.charAt(1);
                this.converted.push(t),
                '2' == a && this.converted.push(t)
            }
            )
        }
        convertMove(e) {
    ...
    class S {
        ...
        cube(e, t=!1) {
            ...
            this.tweens.cube = new b({
                ...
                onUpdate: s => {
                    this.game.cube.animator.position.y = e ? t ? .9 + 3.5 * (1 - s.value) : 4 * (1 - s.value) : a + 4 * s.value,
                    this.game.cube.animator.rotation.x = e ? (1 - s.value) * i / 3 : o + s.value * -i / 3
                }
            }),
            t && (e ? (this.game.world.camera.zoom = .75,
            this.game.world.camera.updateProjectionMatrix()) : setTimeout( () => {
                this.game.world.camera.zoom = this.data.cameraZoom,
                this.game.world.camera.updateProjectionMatrix()
            }
            , 1500)),
        ...
        float() {
            ...
            this.tweens.float = new b({
                ...
                yoyo: !0,
                onUpdate: e => {
                    this.game.cube.holder.position.y = -.02 + .04 * e.value,
                    this.game.cube.holder.rotation.x = .005 - .01 * e.value,
        ...
        complete(e, t) {
            ...
            this.flipLetters(t ? 'best' : 'complete', o, e),
            a.style.opacity = 1;
            const s = this.durations[t ? 'best' : 'complete'];
            e || setTimeout( () => this.game.dom.texts.timer.style.transform = '', s),
    ...
    class w extends g {
        ...
        update() {
            ...
            this.deltaTime = this.currentTime - this.startTime,
            this.convert(),
            this.converted != e && (localStorage.setItem('theCube_time', this.deltaTime),
            this.setText())
        }
        convert() {
    ...
    document.querySelectorAll('range').forEach(e => {
        ...
        e.hasAttribute('color') && (a.classList.add('range--type-color'),
        a.classList.add('range--color-' + e.getAttribute('name'))),
        e.hasAttribute('list') && e.getAttribute('list').split(',').forEach(e => {
            const t = document.createElement('div');
            t.innerHTML = e,
            s.appendChild(t)
        }
    ...
    class C {
        ...
        setValue(e) {
            this.value = this.round(this.limitValue(e)),
    ...
    class T {
        ...
        start() {
            0 < this.started || this.holders.forEach(e => {
                this.game.world.scene.add(e.holder),
                e.start(),
                this.started++
            }
            )
        ...
        stop() {
            0 == this.started || this.holders.forEach(e => {
                e.stop( () => {
                    this.game.world.scene.remove(e.holder),
                    this.started--
                }
                )
            }
    ...
    class M extends g {
        constructor(e, t, a, o) {
            ...
            for (let s = this.count; s--; )
                this.particles.push(new A(this))
        }
        start() {
            this.time = performance.now(),
            this.playing = !0;
            for (let e = this.count; e--; )
                this.particles[e].reset();
            super.start()
        }
        stop(e) {
            this.playing = !1,
        ...
        resizeViewport() {
            ...
            this.height = 2 * m(e / 2) * (this.game.world.camera.position.length() - this.distanceFromCube),
    ...
    class A {
        ...
        reset(e=!0) {
            this.completed = !1,
            this.color = new THREE.Color(this.options.colors[d(Math.random() * this.options.colors.length)]),
            this.mesh.material.color.set(this.color),
            this.speed = -1 * THREE.Math.randFloat(this.options.speed.min, this.options.speed.max),
            this.mesh.position.x = THREE.Math.randFloat(-this.confetti.width / 2, this.confetti.width / 2),
            this.mesh.position.y = e ? THREE.Math.randFloat(this.size, this.confetti.height + this.size) : this.size,
            ...
            this.mesh.rotation.set(Math.random() * i / 3, Math.random() * i / 3, Math.random() * i / 3)
        }
        stop() {
            this.completed = !0,
    ...
    class E {
        ...
        addScore(e) {
            ...
            t.scores.push(e),
            t.solves++,
            100 < t.scores.lenght && t.scores.shift();
            let a = !1;
            return (e < t.best || 0 === t.best) && (t.best = e,
            a = !0),
            e > t.worst && (t.worst = e),
        ...
        setStat(e, t) {
            0 === t && (t = '-'),
            this.game.dom.stats.querySelector(`.stats[name="${e}"] b`).innerHTML = t
        }
        getAverage(e) {
            const t = this.data[this.game.cube.sizeGenerated];
    ...
    class P {
        constructor(e) {
            ...
            t && t === window.gameVersion || (this.clearGame(),
        ...
        loadGame() {
            try {
                ...
                if (!t || null === a)
                    throw new Error;
                if (t.size !== this.game.cube.sizeGenerated)
                    throw new Error;
        ...
        loadPreferences() {
            try {
                ...
                if (!e)
                    throw new Error;
                return this.game.cube.size = parseInt(e.cubeSize),
    ...
    class D {
        ...
        setTheme(e=!1, t=!1) {
            ...
            this.game.dom.back.style.background = '#' + a.G.toString(16).padStart(6, '0')
        }
    }
    class _ {
        constructor(e) {
            ...
            if (t) {
                ...
                this.tweenHSL = new b({
                    ...
                    onUpdate: d => {
                        ...
                        i.track.style.color = this.colorFromHSL(360 * p.h, 100, 50).getStyle(),
                        l.track.style.color = this.colorFromHSL(360 * p.h, 100 * p.s, 50).getStyle(),
        ...
        updateHSL() {
            const {hue: e, saturation: t, lightness: a} = this.game.preferences.ranges
              , o = e.value
              , r = t.value
              , s = a.value
            ...
            this.game.themes.colors[i][this.editColor] = this.colorFromHSL(o, r, s).getHex(),
    ...
    window.game = new class {
            ...
            this.dom.game.addEventListener('click', () => {
                if (!(0 < this.transition.activeTransitions) && this.state !== I.Playing)
                    if (this.state === I.Menu) {
                        ...
                        this.state === I.Complete ? this.complete(!1) : this.state === I.Stats && this.stats(!1)
            }
            , !1),
            this.controls.onMove = () => {
                this.newGame && (this.timer.start(!0),
                this.newGame = !1)
            }
            ,
        ...
        game(e) {
            if (e) {
                this.saved || (this.scrambler.scramble(),
                ...
                setTimeout( () => this.transition.title(!0), this.transition.durations.zoom - 1e3),
                this.playing = !1,
                this.controls.disable()
        }
        prefs(e) {
            if (e) {
                if (0 < this.transition.activeTransitions)
                    return;
                this.state = I.Prefs,
        ...
        theme(e) {
            if (this.themeEditor.colorPicker(e),
            e) {
                if (0 < this.transition.activeTransitions)
                    return;
        ...
        complete(e) {
            return e ? void (this.transition.buttons(H.Complete, H.Playing),
